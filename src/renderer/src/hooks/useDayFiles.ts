...
/**
 * Los archivos de un día, del índice — metadata, no data. Se re-lee por
 * minuto: para HOY refleja lo que va aterrizando; para días viejos main
 * responde de su cache, sin costo.
 */
